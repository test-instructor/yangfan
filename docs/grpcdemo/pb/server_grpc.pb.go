...
type ServerDemoClient interface {
	...
	DemoData(ctx context.Context, in *DemoReq, opts ...grpc.CallOption) (*DemoReq, error)
}
...
func (c *serverDemoClient) DemoData(ctx context.Context, in *DemoReq, opts ...grpc.CallOption) (*DemoReq, error) {
	out := new(DemoReq)
	err := c.cc.Invoke(ctx, "/proto.ServerDemo/demoData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServerDemoServer interface {
	...
	DemoData(context.Context, *DemoReq) (*DemoReq, error)
...
func (UnimplementedServerDemoServer) DemoData(context.Context, *DemoReq) (*DemoReq, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DemoData not implemented")
}
...
func _ServerDemo_DemoData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DemoReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServerDemoServer).DemoData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.ServerDemo/demoData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServerDemoServer).DemoData(ctx, req.(*DemoReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ServerDemo_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "demoData",
			Handler:    _ServerDemo_DemoData_Handler,
		},
	},
