...
CREATE TABLE `api_case_steps` (
  ...
  `api_step_type` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '性能测试step类型',
  `api_env_name` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '所属环境名称',
...
CREATE TABLE `api_cases` (
  ...
  `delete_by_id` bigint unsigned DEFAULT NULL COMMENT '删除者',
  `project_id` bigint unsigned DEFAULT NULL,
  `name` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '用例名称',
  `status` tinyint(1) DEFAULT NULL COMMENT '状态',
  `describe` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '备注',
...
CREATE TABLE `api_configs` (
  ...
  `base_url` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '默认域名',
  ...
  `export` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '导出参数',
...
CREATE TABLE `api_envs` (
  ...
  `key` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `name` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remarks` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `api_grpcs` (
  ...
  `updated_at` datetime(3) DEFAULT NULL,
  `deleted_at` datetime(3) DEFAULT NULL,
  `url` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '请求地址',
  `headers` json DEFAULT NULL COMMENT '请求头',
  `headers_json` json DEFAULT NULL COMMENT '请求头json数据格式',
  `body` json DEFAULT NULL COMMENT '请求体',
  `timeout` float DEFAULT NULL COMMENT '超时时间',
  `type` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '请求类型',
...
CREATE TABLE `api_menus` (
  ...
  `delete_by_id` bigint unsigned DEFAULT NULL COMMENT '删除者',
  `project_id` bigint unsigned DEFAULT NULL,
  `name` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '菜单名称',
  `parent` bigint unsigned DEFAULT NULL COMMENT '父节点id',
  `menu_type` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '菜单类型',
  PRIMARY KEY (`id`),
...
CREATE TABLE `api_report_details` (
  ...
  `root_dir` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `api_report_details_records` (
  ...
  `name` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `step_type` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `success` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `api_reports` (
  ...
  `describe` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `api_env_name` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '所属环境名称',
  `api_env_id` bigint unsigned DEFAULT NULL COMMENT '所属环境',
  PRIMARY KEY (`id`),
...
CREATE TABLE `api_requests` (
  ...
  `updated_at` datetime(3) DEFAULT NULL,
  `deleted_at` datetime(3) DEFAULT NULL,
  `agreement` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '协议',
  `method` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '请求方法',
  `http2` tinyint(1) DEFAULT NULL COMMENT '是否为http2',
  `url` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '请求url',
...
CREATE TABLE `api_steps` (
  ...
  `delete_by_id` bigint unsigned DEFAULT NULL COMMENT '删除者',
  `project_id` bigint unsigned DEFAULT NULL,
  `name` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '接口名称',
  ...
  `validate` text COLLATE utf8mb4_general_ci COMMENT '断言',
  `validate_number` bigint unsigned DEFAULT NULL,
  `validate_json` json DEFAULT NULL,
  `extract_json` json DEFAULT NULL,
  `variables_json` json DEFAULT NULL,
  `hooks` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `setup_hooks` text COLLATE utf8mb4_general_ci,
  `teardown_hooks` text COLLATE utf8mb4_general_ci,
...
CREATE TABLE `api_timer_tasks` (
  ...
  `delete_by_id` bigint unsigned DEFAULT NULL COMMENT '删除者',
  `project_id` bigint unsigned DEFAULT NULL,
  `name` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '任务名称',
  `run_time` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '运行时间cron',
...
CREATE TABLE `performance_report_total_stats` (
  ...
  `deleted_at` datetime(3) DEFAULT NULL,
  `name` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `method` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `performance_report_works` (
  ...
  `updated_at` datetime(3) DEFAULT NULL,
  `deleted_at` datetime(3) DEFAULT NULL,
  `work_id` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ip` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `os` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `arch` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `state` int DEFAULT NULL,
...
CREATE TABLE `performances` (
  ...
  `delete_by_id` bigint unsigned DEFAULT NULL COMMENT '删除者',
  `project_id` bigint unsigned DEFAULT NULL,
  `name` varchar(191) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '性能任务名称',
...
) ENGINE=InnoDB AUTO_INCREMENT=213 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_authorities` (`created_at`, `updated_at`, `deleted_at`, `authority_id`, `authority_name`, `parent_id`, `default_router`) VALUES ('2022-07-11 17:39:20.502', '2022-11-22 14:49:25.905', NULL, 666, '飞书登录默认角色', 0, 'person');
INSERT INTO `sys_authorities` (`created_at`, `updated_at`, `deleted_at`, `authority_id`, `authority_name`, `parent_id`, `default_router`) VALUES ('2022-07-10 15:12:15.356', '2023-05-09 17:57:25.273', NULL, 888, '普通用户', 0, 'dashboard');
...
INSERT INTO `sys_authority_menus` (`sys_base_menu_id`, `sys_authority_authority_id`) VALUES (1, 9999);
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (1, '2022-07-10 15:12:16.165', '2022-07-10 15:12:16.165', NULL, 0, '0', 'dashboard', 'dashboard', 0, 'view/dashboard/index.vue', 1, 0, 0, '仪表盘', 'odometer', 0);
...
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (22, '2022-07-10 15:12:16.165', '2022-07-10 15:12:16.165', NULL, 0, '0', 'https://www.gin-vue-admin.com', 'https://www.gin-vue-admin.com', 0, '/', 0, 0, 0, '官方网站', 'home-filled', 0);
...
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (32, '2022-01-19 01:09:37.274', '2023-05-18 23:29:40.795', NULL, 0, '3', 'project', 'project', 0, 'view/project/project.vue', 1, 0, 0, '项目管理', 'aim', 0);
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (33, '2022-01-23 18:34:58.647', '2023-05-18 23:29:40.811', NULL, 0, '0', 'interfaces', 'interfaces', 0, 'view/interface/index.vue', 4, 0, 0, '接口自动化', 'box', 0);
...
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (42, '2022-06-07 13:37:19.135', '2023-05-18 23:29:40.899', NULL, 0, '33', 'report', 'report', 0, 'view/interface/Reports/report.vue', 600, 0, 0, '测试报告', 'compass', 0);
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (43, '2022-06-08 17:40:11.776', '2023-05-18 23:29:40.915', NULL, 0, '33', 'reportDetail/:id', 'reportDetail', 1, 'view/interface/Reports/reportDetail.vue', 99999, 0, 0, '测试报告详情-${id}', 'document', 0);
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (44, '2022-06-21 17:34:55.263', '2023-05-18 23:29:40.930', NULL, 0, '33', 'testCase', 'testCase', 0, 'view/interface/apiCase/apiCase.vue', 400, 0, 0, '测试用例', 'briefcase', 0);
...
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (46, '2022-07-12 11:39:29.347', '2023-05-18 23:29:40.945', NULL, 0, '33', 'debugtalk', 'debugtalk', 0, 'view/interface/debugtalk/debugtalk.vue', 700, 0, 0, '驱动函数', 'reading', 0);
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (47, '2022-07-12 11:40:03.210', '2023-05-18 23:29:40.959', NULL, 0, '33', 'debugtalkGen', 'debugtalkGen', 1, 'view/interface/debugtalk/debugtalkGen.vue', 99999, 0, 0, 'debugtalkGen', 'aim', 0);
...
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (49, '2022-08-01 06:08:02.383', '2023-05-18 23:29:40.974', NULL, 0, '33', 'apisCaseDetail/:id', 'apisCaseDetail', 1, 'view/interface/apiCase/apisCaseDetail.vue', 99999, 0, 0, '用例详情-${id}', 'aim', 0);
...
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (53, '2022-06-21 17:34:55.263', '2023-05-18 23:29:41.004', NULL, 0, '33', 'timerTask', 'timerTask', 0, 'view/interface/timerTask/timerTask.vue', 500, 0, 0, '定时任务', 'timer', 0);
...
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (55, '2022-10-08 19:30:47.868', '2023-05-18 23:29:41.018', NULL, 0, '0', 'performance', 'performance', 0, 'view/performance/index.vue', 5, 0, 0, '性能测试', 'stopwatch', 0);
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (56, '2022-10-08 19:51:05.009', '2023-05-18 23:29:41.033', NULL, 0, '55', 'performanceTask', 'performanceTask', 0, 'view/performance/task/index.vue', 1, 0, 0, '性能任务', 'cpu', 0);
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (57, '2022-10-11 14:27:10.146', '2023-05-18 23:29:41.048', NULL, 0, '55', 'performanceDetail/:id', 'performanceDetail', 1, 'view/performance/task/taskDetail.vue', 99999, 0, 0, '性能任务详情-${id}', 'aim', 0);
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (58, '2022-11-03 15:49:19.428', '2023-05-18 23:29:41.061', NULL, 0, '55', 'pReport', 'pReport', 0, 'view/performance/report.vue', 2, 0, 0, '性能测试报告', 'compass', 0);
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (59, '2022-11-03 18:59:54.997', '2023-05-18 23:29:41.075', NULL, 0, '55', 'pReportDetail/:id', 'pReportDetail', 1, 'view/performance/reportDetail.vue', 999, 0, 0, '性能测试报告详情-${id}', 'document', 0);
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (60, '2023-05-09 17:39:19.121', '2023-05-18 23:29:41.090', NULL, 0, '33', 'jsonCompare', 'jsonCompare', 1, 'view/interface/interfaceComponents/jsonCompare.vue', 99999, 0, 0, 'json', 'aim', 0);
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (61, '2023-05-09 17:39:19.132', '2023-05-18 23:29:41.103', NULL, 0, '33', 'env', 'env', 0, 'view/interface/environment/environment.vue', 0, 0, 0, '环境变量', 'grid', 0);
INSERT INTO `sys_base_menus` (`id`, `created_at`, `updated_at`, `deleted_at`, `menu_level`, `parent_id`, `path`, `name`, `hidden`, `component`, `sort`, `keep_alive`, `default_menu`, `title`, `icon`, `close_tab`) VALUES (62, '2023-05-09 17:39:19.144', '2023-05-18 23:29:41.116', NULL, 0, '33', 'py_pkg', 'py_pkg', 0, 'view/py_pkg/py_pkg.vue', 680, 0, 0, 'py库管理', 'office-building', 0);
COMMIT;
