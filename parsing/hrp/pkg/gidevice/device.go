...
import (
	...
	"github.com/test-instructor/yangfan/parsing/hrp/pkg/gidevice/pkg/ipa"
	"github.com/test-instructor/yangfan/parsing/hrp/pkg/gidevice/pkg/libimobiledevice"
	"github.com/test-instructor/yangfan/parsing/hrp/pkg/gidevice/pkg/nskeyedarchiver"
)
...
func (d *device) XCTest(bundleID string, opts ...XCTestOption) (out <-chan string, cancel context.CancelFunc, err error) {
	...
	// see https://github.com/test-instructor/yangfan/parsing/hrp/pkg/gidevice/issues/31
