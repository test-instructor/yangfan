...
type ApiConfig struct {
	...
	Parameters     datatypes.JSON      `json:"parameters" form:"parameters" gorm:"column:parameters;comment:;type:text"`
	...
	SetupCase      *ApiTestCase        `json:"setup_case"`
	SetupCaseID    *uint               `json:"setup_case_id"`
	ProjectID      uint                `json:"-"`
