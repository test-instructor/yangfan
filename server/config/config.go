...
type Server struct {
	...
	// Runner配置
	Runner Runner `mapstructure:"runner" json:"runner" yaml:"runner"`

	// 数据仓库配置
	DataWarehouse DataWarehouse `mapstructure:"data-warehouse" json:"data-warehouse" yaml:"data-warehouse"`
}
