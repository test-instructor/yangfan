...
func RegisterMenus() {
	entities := []system.SysBaseMenu{
		...
		{GVA_MODEL: global.GVA_MODEL{ID: 33, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "0", Path: "interfaces", Name: "interfaces", Component: "view/interface/index.vue", Sort: 8, Meta: system.Meta{KeepAlive: true, Title: "接口自动化", Icon: "box"}},
		...
		{GVA_MODEL: global.GVA_MODEL{ID: 55, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "0", Path: "performance", Name: "performance", Component: "view/performance/index.vue", Sort: 10, Meta: system.Meta{KeepAlive: true, Title: "性能测试", Icon: "stopwatch"}},
		...
		{GVA_MODEL: global.GVA_MODEL{ID: 83, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "0", Path: "baseConfig", Name: "baseConfig", Component: "view/routerHolder.vue", Sort: 5, Meta: system.Meta{KeepAlive: false, Title: "基础配置", Icon: "setting"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 84, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "83", Path: "project-auth", Name: "project-auth", Component: "view/project/authority.vue", Sort: 100, Meta: system.Meta{KeepAlive: true, Title: "项目权限", Icon: "avatar"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 61, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "83", Path: "env", Name: "env", Component: "view/interface/environment/environment.vue", Sort: 300, Meta: system.Meta{KeepAlive: true, Title: "环境变量", Icon: "grid"}},
		...
		{GVA_MODEL: global.GVA_MODEL{ID: 85, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "83", Path: "env-mock", Name: "env-mock", Component: "view/interface/environment/mock.vue", Sort: 400, Meta: system.Meta{KeepAlive: true, Title: "mock", Icon: "data-board"}},
	}
