...
func RegisterMenus() {
	entities := []system.SysBaseMenu{
		...
		{GVA_MODEL: global.GVA_MODEL{ID: 81, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "83", Path: "project-auth", Name: "project-auth", Component: "view/project/authority.vue", Sort: 100, Meta: system.Meta{KeepAlive: true, Title: "项目权限", Icon: "avatar"}},
