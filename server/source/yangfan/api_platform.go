...
func RegisterApis() {
	entities := []system.SysApi{
		...
		{ApiGroup: "测试套件", Method: "GET", Path: "/case/:project/step/findTestCase", Description: "根据ID获取测试套件"},
		{ApiGroup: "测试套件", Method: "GET", Path: "/case/:project/step/getTestCaseList", Description: "获取测试套件列表"},
		{ApiGroup: "测试套件", Method: "POST", Path: "/case/:project/step/getTestCaseList", Description: "测试套件列表排序"},
		{ApiGroup: "测试套件", Method: "POST", Path: "/case/:project/step/addTestCase", Description: "测试套件添加api"},
		{ApiGroup: "测试套件", Method: "DELETE", Path: "/case/:project/step/delTestCase", Description: "删除测试套件关联的api"},
		{ApiGroup: "测试套件", Method: "POST", Path: "/case/:project/step/sortTestCase", Description: "测试套件排序"},
		{ApiGroup: "测试套件", Method: "POST", Path: "/case/:project/step/createTestCase", Description: "新增测试套件"},
		{ApiGroup: "测试套件", Method: "DELETE", Path: "/case/:project/step/deleteTestCase", Description: "删除测试套件"},
		{ApiGroup: "测试套件", Method: "DELETE", Path: "/case/:project/step/deleteTestCaseByIds", Description: "批量删除测试套件"},
		{ApiGroup: "测试套件", Method: "PUT", Path: "/case/:project/step/updateTestCase", Description: "更新测试套件"},
		...
		{ApiGroup: "测试用例", Method: "DELETE", Path: "/testcase/:project/delApisCase", Description: "定时任务删除测试套件"},
		...
		{ApiGroup: "测试用例", Method: "POST", Path: "/testcase/:project/setApisCase", Description: "测试用例设置测试套件"},
		...
		{ApiGroup: "测试用例", Method: "POST", Path: "/testcase/:project/sortApisCase", Description: "测试套件排序"},
		{ApiGroup: "测试用例", Method: "POST", Path: "/testcase/:project/AddApiTestCase", Description: "任务添加测试套件"},
		...
		{ApiGroup: "环境变量", Method: "POST", Path: "/env/:project/findEnv", Description: "通过id查找环境"},
		...
		{ApiGroup: "环境变量", Method: "DELETE", Path: "/env/:project/deleteEnvVariable", Description: "新增变量"},
...
func RegisterMenus() {
	entities := []system.SysBaseMenu{
		{GVA_MODEL: global.GVA_MODEL{ID: 32, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "3", Path: "project", Name: "project", Component: "view/project/project.vue", Sort: 1, Meta: system.Meta{Title: "项目管理", Icon: "aim"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 33, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "0", Path: "interfaces", Name: "interfaces", Component: "view/interface/index.vue", Sort: 4, Meta: system.Meta{Title: "接口自动化", Icon: "box"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 34, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "33", Path: "interfacetemplate", Name: "interfacetemplate", Component: "view/interface/interfaceTemplate/interfaceTemplate.vue", Sort: 200, Meta: system.Meta{Title: "接口管理", Icon: "coin"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 35, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: true, ParentId: "33", Path: "DebugReport", Name: "DebugReport", Component: "view/interface/interfaceReport/DebugReport.vue", Sort: 99999, Meta: system.Meta{Title: "DebugReport", Icon: "aim"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 36, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "33", Path: "apiConfig", Name: "apiConfig", Component: "view/interface/interfaceTemplate/apiConfig.vue", Sort: 100, Meta: system.Meta{Title: "配置管理", Icon: "expand"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 37, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "33", Path: "testCaseStep", Name: "testCaseStep", Component: "view/interface/testCaseStep/testCaseStep.vue", Sort: 300, Meta: system.Meta{Title: "测试套件", Icon: "suitcase"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 38, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: true, ParentId: "33", Path: "testCaseStepDetail/:id", Name: "testCaseStepDetail", Component: "view/interface/testCaseStep/testCaseStepDetail.vue", Sort: 99999, Meta: system.Meta{Title: "套件详情-${id}", Icon: "finished"}},
		//{GVA_MODEL: global.GVA_MODEL{ID: 39, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "33", Path: "apiTest", Name: "apiTest", Component: "view/interface/test.vue", Sort: 0, Meta: system.Meta{Title: "测试", Icon: "aim"}},
		//{GVA_MODEL: global.GVA_MODEL{ID: 40, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "33", Path: "testCaseAdd", Name: "testCaseAdd", Component: "view/interface/testCase/testCaseAdd.vue", Sort: 0, Meta: system.Meta{Title: "添加测试用例", Icon: "aim"}},
		//{GVA_MODEL: global.GVA_MODEL{ID: 41, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "33", Path: "apiTest2", Name: "apiTest2", Component: "view/interface/test2.vue", Sort: 0, Meta: system.Meta{Title: "测试2", Icon: "aim"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 42, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "33", Path: "report", Name: "report", Component: "view/interface/Reports/report.vue", Sort: 600, Meta: system.Meta{Title: "测试报告", Icon: "compass"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 43, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: true, ParentId: "33", Path: "reportDetail/:id", Name: "reportDetail", Component: "view/interface/Reports/reportDetail.vue", Sort: 99999, Meta: system.Meta{Title: "测试报告详情-${id}", Icon: "document"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 44, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "33", Path: "testCase", Name: "testCase", Component: "view/interface/apiCase/apiCase.vue", Sort: 400, Meta: system.Meta{Title: "测试用例", Icon: "briefcase"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 46, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "33", Path: "debugtalk", Name: "debugtalk", Component: "view/interface/debugtalk/debugtalk.vue", Sort: 700, Meta: system.Meta{Title: "驱动函数", Icon: "reading"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 47, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: true, ParentId: "33", Path: "debugtalkGen", Name: "debugtalkGen", Component: "view/interface/debugtalk/debugtalkGen.vue", Sort: 99999, Meta: system.Meta{Title: "debugtalkGen", Icon: "aim"}},
		//{GVA_MODEL: global.GVA_MODEL{ID: 48, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "33", Path: "taskAddCase", Name: "taskAddCase", Component: "view/interface/timerTask/taskAddCase.vue", Sort: 0, Meta: system.Meta{Title: "任务添加测试用例", Icon: "aim"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 49, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: true, ParentId: "33", Path: "apisCaseDetail/:id", Name: "apisCaseDetail", Component: "view/interface/apiCase/apisCaseDetail.vue", Sort: 99999, Meta: system.Meta{Title: "用例详情-${id}", Icon: "aim"}},
		//{GVA_MODEL: global.GVA_MODEL{ID: 50, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "33", Path: "envConfig", Name: "envConfig", Component: "view/interface/interfaceComponents/envConfig.vue", Sort: 1, Meta: system.Meta{Title: "envConfig", Icon: "aim"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 51, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: true, ParentId: "33", Path: "taskCaseDetail/:id", Name: "taskCaseDetail", Component: "view/interface/timerTask/taskCaseDetail.vue", Sort: 99999, Meta: system.Meta{Title: "任务详情-${id}", Icon: "aim"}},
		//{GVA_MODEL: global.GVA_MODEL{ID: 52, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "33", Path: "taskAddCase", Name: "taskAddCase", Component: "view/interface/timerTask/taskAddCase.vue", Sort: 0, Meta: system.Meta{Title: "任务添加测试用例", Icon: "aim"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 53, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "33", Path: "timerTask", Name: "timerTask", Component: "view/interface/timerTask/timerTask.vue", Sort: 500, Meta: system.Meta{Title: "定时任务", Icon: "timer"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 55, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "0", Path: "performance", Name: "performance", Component: "view/performance/index.vue", Sort: 5, Meta: system.Meta{Title: "性能测试", Icon: "stopwatch"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 56, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "55", Path: "performanceTask", Name: "performanceTask", Component: "view/performance/task/index.vue", Sort: 1, Meta: system.Meta{Title: "性能任务", Icon: "cpu"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 57, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: true, ParentId: "55", Path: "performanceDetail/:id", Name: "performanceDetail", Component: "view/performance/task/taskDetail.vue", Sort: 99999, Meta: system.Meta{Title: "性能任务详情-${id}", Icon: "aim"}},
		{GVA_MODEL: global.GVA_MODEL{ID: 58, CreatedAt: time.Time{}, UpdatedAt: time.Time{}, DeletedAt: gorm.DeletedAt{}}, MenuLevel: 0, Hidden: false, ParentId: "55", Path: "pReport", Name: "pReport", Component: "view/performance/report.vue", Sort: 2, Meta: system.Meta{Title: "性能测试报告", Icon: "compass"}},
