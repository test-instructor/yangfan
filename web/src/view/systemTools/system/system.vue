  ...
  <div class="system">
    <el-form ref="form" :model="config" label-width="240px">
      ...
      <el-tabs v-model="activeNames">
        ...
        <el-tab-pane label="MQ配置" name="15" class="mt-3.5">
          <el-form-item label="MQ类型">
            <el-select
              v-model="config.mq.type"
              class="w-full"
              placeholder="请选择MQ类型(留空则不启用)"
            >
              <el-option value="" label="不启用" />
              <el-option value="rabbitmq" label="RabbitMQ" />
              <el-option value="rocketmq" label="RocketMQ（暂未实现）" disabled />
              <el-option value="kafka" label="Kafka（暂未实现）" disabled />
            </el-select>
          </el-form-item>

          <template v-if="config.mq.type">
            <el-form-item label="Host">
              <el-input
                v-model.trim="config.mq.host"
                placeholder="请输入MQ服务器地址"
              />
            </el-form-item>
            <el-form-item label="Port">
              <el-input-number
                v-model="config.mq.port"
                :min="1"
                :max="65535"
              />
            </el-form-item>
            <el-form-item label="用户名">
              <el-input
                v-model.trim="config.mq.username"
                placeholder="请输入用户名"
              />
            </el-form-item>
            <el-form-item label="密码">
              <el-input
                v-model.trim="config.mq.password"
                type="password"
                show-password
                placeholder="请输入密码"
              />
            ...
            <el-form-item
              label="Virtual Host"
              v-if="config.mq.type === 'rabbitmq'"
            >
              <el-input
                v-model.trim="config.mq['virtual-host']"
                placeholder="例如 /"
              />
            </el-form-item>
            ...
            <el-form-item label="Exchange">
              <el-input
                v-model.trim="config.mq.exchange"
            ...
            <el-form-item label="重试次数">
              <el-input-number
                v-model="config.mq['retry-count']"
                :min="0"
              />
            </el-form-item>
            <el-form-item label="连接超时(秒)">
              <el-input-number v-model="config.mq.timeout" :min="0" />
            </el-form-item>
            <el-form-item label="心跳间隔(秒)">
              <el-input-number v-model="config.mq.heartbeat" :min="0" />
            </el-form-item>
            <el-form-item label="Prefetch 数量">
              <el-input-number
                v-model="config.mq['prefetch-count']"
                :min="0"
              />
            </el-form-item>
            <el-form-item label="队列持久化">
              <el-switch v-model="config.mq.durable" />
            </el-form-item>
            <el-form-item label="自动删除队列">
              <el-switch v-model="config.mq['auto-delete']" />
            </el-form-item>
          </template>
        </el-tab-pane>
