  ...
  <div style="height:300px;">
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" label="菜单类型" prop="menuType" width="120"/>
        <el-table-column align="left" label="按钮组">
          <template #default="scope">
            <el-button class="table-button" icon="edit" size="small" type="text" @click="updateApiMenuFunc(scope.row)">
              变更
            </el-button>
...
const getTableData = async () => {
  const table = await getApiMenuList({page: page.value, pageSize: pageSize.value, ...searchInfo.value})
  if (table.code === 0) {
