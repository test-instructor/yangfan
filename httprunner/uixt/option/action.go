...
// DriverType specifies which driver to use for an action
type DriverType string

const (
	DriverTypeAuto DriverType = "auto" // default, auto-select based on device options
	DriverTypeADB  DriverType = "adb"  // force use ADB driver
	DriverTypeUIA2 DriverType = "uia2" // force use UIA2 driver
)
...
type ActionOptions struct {
	...
	// Driver selection for per-operation driver switching (Android only)
	DriverType DriverType `json:"driver_type,omitempty" yaml:"driver_type,omitempty" desc:"Driver type for this action: auto/adb/uia2"`
...
// WithDriverType sets the driver type for this action (Android only)
// Use DriverTypeADB for adb driver, DriverTypeUIA2 for uia2 driver
// or DriverTypeAuto (default) to use device's default driver
func WithDriverType(driverType DriverType) ActionOption {
	return func(o *ActionOptions) {
		o.DriverType = driverType
	}
}

// WithADBDriver is a shortcut for WithDriverType(DriverTypeADB)
func WithADBDriver() ActionOption {
	return WithDriverType(DriverTypeADB)
}

// WithUIA2Driver is a shortcut for WithDriverType(DriverTypeUIA2)
func WithUIA2Driver() ActionOption {
	return WithDriverType(DriverTypeUIA2)
}
